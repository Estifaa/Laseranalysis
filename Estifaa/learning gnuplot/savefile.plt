...
unset style line
set style line 1  linetype 1 linecolor rgb "#0060ad"  linewidth 2.000 pointtype 1 pointsize default pointinterval 0
set style line 2  linetype 1 linecolor rgb "#dd181f"  linewidth 2.000 pointtype 1 pointsize default pointinterval 0
unset style arrow
...
GPFUN_f = "f(x) = a*sin(x)"
GPFUN_g = "g(x) = a*cos(x)"
plot f(x) title 'sin(x)' with lines ls 1, g(x) title 'g(x)' with lines ls 2
#    EOF
